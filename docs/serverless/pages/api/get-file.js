...
/******/ 	return __webpack_require__(__webpack_require__.s = "XsA4");
/******/ })
/************************************************************************/
/******/ ({
 ...
 */
const exportMap = __webpack_require__("P6qu"),
      configDefaults = __webpack_require__("7OU8");
...
module.exports = function (conf) {
  _Object$entries(conf).forEach(l1Conf => {
    l1ConfDesc = l1Conf[0];
    l1ConfSet = l1Conf[1];
  ...
  function handleLayoutConfig(layoutConf) {
    ...
    layoutConf.main.classes.errorStackStyle = {
      display: 'none'
    };

    if (!layoutConf.header.classes.main.textAlign) {
      layoutConf.header.classes.main.textAlign = 'center';
    }
  } // Assign markdown config defaults


  function handleMarkdownConfig(markdownConf) {// console.log('markdownConf: ', markdownConf);
...
const {
  ...
  exportMap,
  configDefaults
} = __webpack_require__("79/y"),
      conf = __webpack_require__("PeXd"),
...
/* WEBPACK VAR INJECTION */(function(__dirname) {/* harmony import */ var _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("9Jkg");
/* harmony import */ var _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _req_log__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("P66Z");
/* harmony import */ var config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("8SHQ");
...
/* harmony default export */ __webpack_exports__["default"] = ((req, res) => router.call(undefined, req, res)); // pass request to task router
// Global Variable declarations

const // declare variables
mode = "production" === 'development',
      showReqLog = config__WEBPACK_IMPORTED_MODULE_2__["markdown_config"]['show-api-request-log'],
...
mdFiles = './public/markdown/',
  ...
  console.log('fp: ', fp);
  return fs__WEBPACK_IMPORTED_MODULE_3___default.a.readFileSync(fp, 'utf8');
},
      createErrorResponse = (status, type, message) => {
  throw new Error(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()({
    status,
    type,
    message
  }));
...
function router(req, res) {
  ...
  showReqLog && Object(_req_log__WEBPACK_IMPORTED_MODULE_1__["default"])(req); // switch is in /src/config/conf.json
...
/**
 * EXPORT MAP
 * INFO: creates an export map from the links setting for next.js static pages build procedure
 */
module.exports = function () {
  return 'not configured for this version';
};
...
module.exports = JSON.parse("{\"markdown_config\":{\"show-api-request-log\":true,\"use-common-mark\":false,\"parse-html\":true,\"all-links\":false,\"close-single-tag\":false,\"break-tag-linebreaks\":true,\"typographer\":true,\"link_attributes\":[{\"use-pattern\":false,\"pattern\":\"/^https?:///\",\"attr\":{\"target\":\"_blank\",\"rel\":\"noopener\",\"className\":\"md-links\"}}],\"page-map\":[{\"requestedAs\":\"home-page-markdown\",\"located\":\"README.md\"}],\"error-messages\":{\"use-defaults\":true,\"custom-messages\":{\"invPath\":\"<type custom message for invPath error>\",\"fileNotExist\":\"<type custom message for fileNotExist error>\",\"other\":\"<type custom message for other error>\",\"default\":\"<type custom message for default error>\"}}},\"app_config\":{\"displayBodyText\":false,\"node_path\":[\"./\",\"./src\",\"./src/components\",\"./src/components/core\",\"./src/utils\",\"./src/utils/built-in\",\"./src/styles\",\"./public\"],\"showLayoutProps\":\"all\",\"styles\":[\"https://fonts.googleapis.com/css?family=Kanit|Lato&display=swap\"],\"scripts\":[\"test1.js\",\"test2.js\"]},\"layout_config\":{\"general\":{\"separate-layout-with-hr\":true},\"nav\":{\"useBrandOrTitle\":\"brand\",\"brand\":\"USING BRAND\",\"classes\":{\"main\":{\"display\":\"flex\"},\"navbar-left\":{\"textAlign\":\"left\"},\"navbar-right\":{\"flex\":1,\"textAlign\":\"right\",\"paddingRight\":\"20px\"}},\"links\":[{\"href\":\"/\",\"label\":\"Home\",\"as\":\"home\",\"title\":\"Home Page\"},{\"href\":\"/page-1\",\"label\":\"Page One\",\"as\":\"page-one\",\"title\":\"Page test one\",\"subTitle\":true,\"subTitleText\":\"This is a test page with a sub title\"},{\"href\":\"/page-2\",\"label\":\"Page Two\",\"as\":\"page-two\",\"title\":\"Page test two\",\"subTitle\":true,\"subTitleText\":\"This is a test page with a sub title\"},{\"href\":\"/not-found\",\"label\":\"Not found\",\"as\":\"contact\",\"title\":\"Not found Test Page\",\"subTitle\":true,\"subTitleText\":\"When the markdown file does not exist\"},{\"href\":\"page-error\",\"label\":\"Not implemented\",\"as\":\"page-error\",\"title\":\"<This will not display because this page is not implemented>\",\"subTitle\":true,\"subTitleText\":\"<This will not display because this page is not implemented>\"}]},\"header\":{\"classes\":{\"main\":{\"display\":\"block\",\"textAlign\":\"left\",\"maxWidth\":\"600px\",\"margin\":\"auto\"}}},\"main\":{\"classes\":{\"main\":{\"display\":\"block\"}}},\"footer\":{\"classes\":{\"main\":{\"display\":\"block\"}}}},\"dev-config\":{\"display_App_component_mount\":true,\"display_App_component_update\":true}}");
...
/* harmony import */ var next_dist_next_server_server_api_utils__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(next_dist_next_server_server_api_utils__WEBPACK_IMPORTED_MODULE_1__);
      ...
      /* harmony default export */ __webpack_exports__["default"] = ((req, res) => {
        const params = {}
        const resolver = __webpack_require__("Os93")
